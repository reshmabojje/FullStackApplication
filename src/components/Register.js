...
function Register() {
    ...
    async function save(event) {
        ...
        try {
            let url = "http://12.0.2.208:8085/api/v1/employee/save";
            if (role === "admin") {
                url = "http://12.0.2.208:8085/api/v1/employee/admin/save";
            } else if (role === "semi-user") {
                url = "http://12.0.2.208:8085/api/v1/employee/semi-user/save";
            }
